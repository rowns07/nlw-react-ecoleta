...
const CreatePoint = () => {
    ...
    useEffect(() => {
        ...
        Axios.get<IBGEUCityResponse[]>(`https://servicodados.ibge.gov.br/api/v1/localidades/estados/${selectedUf}/municipios`)
            .then(response => {
                const cityName = response.data.map(cities => cities.nome);
